...
class DataProcessing: 
    ...
    def load_data(self):
        try:
            ...
            logger.info("Read the data successfuly")
        except Exception as e:
            logger.error(f"Error while reading data")
    ...
    def handle_outliers(self, column):
        try:
            ...
            logger.error(f"Error while removing outliers")
            raise CustomException("Failed to remove outliers", e)
    ...
    def split_data(self):
        try:
            ...
            logger.info("Data Splitted successfuly")
